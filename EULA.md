...
**Optional orga blueprint pool:** Verified Users may additionally choose to opt in per (Star Citizen channel × RSI organization) to share their local owned-blueprint list with members of that organization (a free, opt-in feature offered on sc-lexicore.com/orga/blueprints/ and inside the Lexicore desktop app). When they do, the Lexicore desktop app uploads the normalized names of the blueprints from the chosen local channel to sc-lexicore.com. No file contents, paths or other game data are transmitted. Visibility is symmetric: only verified members of the same organization who themselves share at least one opt-in can view the pool. The feature can be revoked granularly per (channel × organization) at any time via the same surfaces, which immediately deletes the corresponding shares on the server through cascading constraints. Details: § 7.8 of the privacy policy at https://sc-lexicore.com/datenschutz.html.
